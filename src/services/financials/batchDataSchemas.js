// src/services/financials/batchDataSchemas.js
    ...
    if (error instanceof z.ZodError) {
      ...
      return {
        ...
        data: {
          ...
          ratiosAnnual: [],
          keyMetrics: [],
          priceHistory: { symbol: data?.ticker || 'UNKNOWN', historical: [] },
          revenueSegments: [],
          dividendHistory: { symbol: data?.ticker || 'UNKNOWN', historical: [] },
          stockSplit: { symbol: data?.ticker || 'UNKNOWN', historical: [] },
          earningsCalendar: [],
          financialScores: [],
          priceTargetSummary: [],
 ...
 */
export function safeParseBatchData(data) {

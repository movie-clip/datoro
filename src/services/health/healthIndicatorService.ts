// src/services/health/healthIndicatorService.ts
 ...
 *
 * @param valuation - Valuation metrics { pe, ps, evEbitda }
 * @returns Health indicator or null if no valid metrics
 */
export function calculateValuationHealth(valuation: ValuationMetrics): HealthIndicator | null {
 ...
 *
 * @param batchData - Batch API response
 * @param ticker - Ticker symbol for caching
 * @param fcfYield - FCF Yield percentage string
 * @returns Health indicator or null if insufficient data
 */
 ...
 *
 * @param balance - Balance sheet data with altmanZScore
 * @returns Health indicator or null if no Z-Score
 */
export function calculateBalanceHealth(balance: BalanceMetrics): HealthIndicator | null {
...
/**
 * Parameters for calculating all health indicators
 */
export interface HealthIndicatorParams {
 ...
 *
 * @param params - All required data
 * @returns Array of health indicators
 */
export function calculateAllHealthIndicators(params: HealthIndicatorParams): HealthIndicator[] {
  const { valuation, batchData, ticker, fcfYield, balance } = params

 ...
 */
router.get('/popular', validate(validateAnalyticsPopular), asyncHandler(async (req, res) => {
 ...
 */
router.get('/history', validate(validateAnalyticsHistory), asyncHandler(async (req, res) => {
 ...
 */
router.get('/stats', adminLimiter, validate(validateAnalyticsStats), asyncHandler(async (req, res) => {

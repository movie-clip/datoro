 ...
 */
export function initSearchRoutes(deps) {
 ...
 */
router.get('/search', fmpLimiter, asyncHandler(async (req, res) => {
 ...
 */
router.get('/deep-finder', fmpLimiter, asyncHandler(async (req, res) => {
  const startTime = Date.now()
